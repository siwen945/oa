package com.xy.oacommon.controller;
...
//    public static <T> Result<T> fault(ReturnFaildCodes failEnum, Map<String,String> ext) {
//
//        return new Result<>(failEnum.getCode(), failEnum.getMessage(),ext);
//    }
//
//    public static <T> Result<T> fault(ReturnFaildCodes returnFaildCodes) {
//
//        return new Result<>(returnFaildCodes.getCode(), returnFaildCodes.getMessage());
//    }
